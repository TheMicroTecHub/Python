    ...
    def __init__(self, markup="", features=None, builder=None,
        ...
        if hasattr(markup, 'read'):        # It's a file-type object.
            ...
            if is_file:
                ...
                warnings.warn(
                    f'"{markup}" looks like a filename, not markup. You should probably open this file and pass the filehandle into Beautiful Soup.'
                )
            if (markup[:5] == "http:" or markup[:6] == "https:") and (
                ...
                if isinstance(markup, str):
                    markup = markup.encode("utf8")
                warnings.warn(
                    f'"{markup}" looks like a URL. Beautiful Soup is not an HTTP client. You should probably use an HTTP client to get the document behind the URL, and feed that document to Beautiful Soup.'
                )
