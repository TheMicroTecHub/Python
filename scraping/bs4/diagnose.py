...
def diagnose(data):
    ...
    if hasattr(data, 'read'):
        ...
        print(f'"{data}" looks like a filename. Reading data from the file.')
        data = open(data).read()
    elif data.startswith("http:") or data.startswith("https:"):
        print(f'"{data}" looks like a URL. Beautiful Soup is not an HTTP client.')
    ...
    for parser in basic_parsers:
        ...
        try:
            ...
            traceback.print_exc()
        if success:
            print(f"Here's what {parser} did with the markup:")
            print(soup.prettify())
